      ...
      <PageTransition>
        ...
        <main className="w-[95%] md:w-[90%] max-w-4xl mx-auto mt-24 md:mt-28 relative z-10">
          <div className="bg-white/60 dark:bg-slate-800/50 backdrop-blur-xl rounded-[40px] shadow-2xl border border-white/40 dark:border-white/10 overflow-hidden transition-colors duration-700 relative">
            ...
            {/* 🌟 核心修改：缩小手机端的内边距 px-5 md:px-16 */}
            <div className="px-5 sm:px-8 md:px-16 pb-10 md:pb-16 relative">

              {/* 🌟 核心修改：头像在手机端自适应缩小 (w-24 -> w-32)，并相应调整上浮边距 (-mt-12 -> -mt-16) */}
              ...
              <div className="mt-4 md:mt-6 mb-6 md:mb-8 border-b border-slate-300/50 dark:border-slate-700 pb-6 md:pb-8 relative">
                {/* 🌟 核心修改：标题和副标题字号响应式伸缩 */}
