    ...
    <div className="w-full max-w-5xl mx-auto px-3 sm:px-10 py-6 md:py-10 relative z-10 scroll-smooth mt-20 md:mt-10">
      ...
      >
        <h2 className="text-lg md:text-2xl font-black text-slate-900 dark:text-white mb-2 md:mb-4 tracking-wider flex items-center justify-center gap-2">
          <Sparkles size={20} strokeWidth={2.5} className="text-indigo-500" />
          建立神经连接
        </h2>
        <p className="text-xs md:text-base text-slate-600 dark:text-slate-400 font-serif mb-4 md:mb-6">
          Copy this profile format when you are ready to exchange links with another site.
        </p>
