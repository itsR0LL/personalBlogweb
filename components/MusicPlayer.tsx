...
export default function CloudPlayer({ songIds }: { songIds: string[] }) {
        ...
        const mergedPlaylist = results
          ...
          .map(res => {
            ...
            return {
              ...
              cover: song.cover || 'https://img.r0l1dehome.asia/site/2026/07/20260710T074808Z-996fce0b337e9f32.jpg',
              src: song.url,
              lrcUrl: song.lrc
            };
          })
  ...
  return (
    <>
      ...
      <div className="md:col-span-5 rounded-3xl bg-white/40 dark:bg-slate-800/50 backdrop-blur-md border border-white/40 dark:border-white/10 shadow-xl p-6 flex flex-col justify-between transition-[transform,color,background-color,border-color] duration-700 hover:scale-[1.01] relative group overflow-hidden min-h-[220px]">
        ...
        <div className="flex items-center gap-5 relative z-10 mb-6 mt-2">
          <div data-ambient-motion="true" className={`w-20 h-20 rounded-full border-2 border-white/50 shadow-lg flex-shrink-0 overflow-hidden relative ${isPlaying ? 'animate-[spin_6s_linear_infinite]' : ''}`}>
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-center gap-6">
            ...
            <button onClick={togglePlay} className="w-12 h-12 bg-indigo-500 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-indigo-600 hover:scale-105 transition-[transform,color,background-color,border-color] duration-300 border-2 border-white/50 dark:border-slate-600">
      ...
      <div className="md:col-span-12 order-last mt-4 rounded-3xl bg-slate-900/80 dark:bg-slate-950/90 backdrop-blur-xl border border-white/10 shadow-2xl p-5 flex items-center justify-between transition-all duration-700 hover:shadow-indigo-500/20 group min-h-[80px]">
        ...
        <div className="w-16 flex justify-end">
          <svg data-ambient-motion="true" className={`w-6 h-6 text-indigo-400/50 ${isPlaying ? 'animate-bounce' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
