  ...
  const handleSaveFriend = () => {
    ...
    if (mode === 'add') {
      const newFriend: Friend = {
        ...
        name: data.name!,
        url: data.url!,
        avatar: data.avatar || 'https://images.unsplash.com/photo-1517077304055-6e89abbf09b0?q=80&w=400&auto=format&fit=crop',
    ...
    <div className="w-full max-w-5xl mx-auto px-4 sm:px-10 py-10 relative z-10">
      ...
      <div className="mb-12 flex flex-col items-center md:items-start">
        ...
        <div className="text-center md:text-left w-full">
          <h1 className="text-4xl font-black text-slate-900 dark:text-white mb-4 tracking-widest drop-shadow-sm uppercase">友链管理</h1>
          <p className="text-slate-600 dark:text-slate-400 font-serif">管理已添加的站点名称、链接、头像和描述。</p>
        </div>
      </div>
