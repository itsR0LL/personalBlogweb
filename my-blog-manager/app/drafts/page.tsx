...
import { AlertTriangle, FileText, Search, X, Sparkles, Pencil } from 'lucide-react';
...
function DraftsContent() {
  ...
  const blogPath = "E:/Project/personalBlogweb";
          ...
          <header className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              <h1 className="text-4xl font-black text-slate-800 dark:text-white mb-3 tracking-wider flex items-center gap-3">
                <FileText size={34} strokeWidth={2.4} className="text-indigo-500" />
                创作草稿箱
