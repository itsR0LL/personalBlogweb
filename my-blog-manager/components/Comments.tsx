...
export default function Comments() {
  ...
  const hasGitalkConfig = Boolean(
    ...
    gitalkConfig.repo &&
    gitalkConfig.owner &&
    gitalkConfig.admin?.some((admin) => admin.trim())
  );
  ...
  }, [gitalkConfig, hasGitalkConfig, pathname]);
  ...
  return (
    <div className="w-full mt-16 relative">
      ...
      {hasGitalkConfig ? (
        ...
        <div className="relative z-10 pt-6 border-t border-slate-200/50 dark:border-slate-700/50 text-sm text-slate-500 dark:text-slate-400">
          Comments are disabled until Gitalk is configured.
        </div>
      )}
