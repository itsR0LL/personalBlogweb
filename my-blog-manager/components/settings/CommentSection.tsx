...
import { Save, Key, User, GitBranch, Shield, MessageCircle } from 'lucide-react';
        ...
        <div className="flex justify-between items-center mb-8 border-b border-white/30 dark:border-slate-700/50 pb-6">
          <div>
            <h2 className="text-2xl font-black text-slate-800 dark:text-white flex items-center gap-2">
              <MessageCircle size={24} strokeWidth={2.4} className="text-indigo-500" />
              评论系统配置
            </h2>
